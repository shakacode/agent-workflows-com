...
description: "Install ShakaCode Workflows and complete your first task with Codex."
---
...
`sw` and the compatible `aw`; see [installing the package](/docs/v2/packaging/).
...
Maintained in the ShakaCode Workflows repository. This page uses [source revision d47e423](https://github.com/shakacode/workflows/blob/d47e423d50170da37888b043a41ba8a3a51050ad/docs/getting-started.md).
