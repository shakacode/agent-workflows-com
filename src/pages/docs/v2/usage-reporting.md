...
description: "Each task reports the available native usage for its commits and contributions. The agent runs the trusted installed helper and includes its output in the PR, or the final response when there is no PR:"
---
